...
def test_create_entity(service):
    ...
    responses.add(
        responses.POST,
        f"{service.url}/MasterEntities?$format=json",
        headers={
...
def test_create_entity_nested(service):
    ...
    responses.add(
        responses.POST,
        f"{service.url}/Cars?$format=json",
        headers={'Content-type': 'application/json'},
        json={'d': {
            'Name': 'Hadraplan',
        }},
...
def test_create_entity_nested_list(service):
    ...
    responses.add(
        responses.POST,
        f"{service.url}/Customers?$format=json",
        headers={'Content-type': 'application/json'},
        json={'d': {
            'Name': 'John',
            'Orders': [
...
def test_get_entity_property(service):
    ...
    responses.add(
        responses.GET,
        f"{service.url}/MasterEntities('12345')?$format=json",
        headers={
            'ETag': 'W/\"J0FtZXJpY2FuIEFpcmxpbmVzJw==\"',
            'Content-type': 'application/json',
        },
...
def test_entity_key_complex(service):
    ...
    responses.add(
        responses.GET,
        f"{service.url}/TemperatureMeasurements(Sensor='sensor1',Date=datetime'2017-12-24T18:00:00')?$format=json",
        headers={'Content-type': 'application/json'},
        json={'d': {
            'Sensor': 'sensor1',
...
def test_function_import_primitive(service):
    ...
    responses.add(
        responses.GET,
        f"{service.url}/sum?$format=json&A=2&B=4",
        headers={'Content-type': 'application/json'},
        json={'d': 6},
        status=200)
...
def test_function_import_escape_parameter(service):
    ...
    responses.add(
        responses.GET,
        f"{service.url}/retrieve?$format=json&Param=%27%26|%2B|%3D|%2F|%3F|+|%40%27",
        headers={'Content-type': 'application/json'},
        json={'d': True},
        status=200)
...
def test_function_import_entity(service):
    ...
    responses.add(
        responses.GET,
        f'{service.url}/get_max?$format=json',
        headers={'Content-type': 'application/json'},
        json={'d': {
...
def test_get_entities(service):
    ...
    responses.add(
        responses.GET,
        f"{service.url}/Employees?$format=json",
        json={'d': {
            'results': [
                {
                    'ID': 669,
...
def test_get_null_value_from_null_preserving_service(service_retain_null):
    ...
    responses.add(
        responses.GET,
        f"{service_retain_null.url}/Employees?$format=json",
        json={'d': {
            'results': [
                {
                    'ID': 1337,
...
def test_navigation_multi(service):
    ...
    responses.add(
        responses.GET,
        f"{service.url}/Employees(23)/Addresses?$format=json",
        json={'d': {
            'results': [
                {
                    'ID': 456,
...
def test_navigation(service):
    ...
    responses.add(
        responses.GET,
        f"{service.url}/Employees(23)/Addresses(456)?$format=json",
        json={'d': {
            'ID': 456,
            'Street': 'Baker Street',
            'City': 'London'
...
def test_navigation_multi_on1(service):
    ...
    responses.add(
        responses.GET,
        f"{service.url}/Customers('Mammon')/ReferredBy?$format=json",
        headers={'Content-type': 'application/json'},
        json = { 'd': {
            'Name': 'John',
            }
...
def test_navigation_1on1(service):
    ...
    responses.add(
        responses.GET,
        f"{service.url}/Cars('Hadraplan')/IDPic?$format=json",
        headers={'Content-type': 'application/json'},
        json = { 'd': {
            'CarName': 'Hadraplan',
            'Content': 'DEADBEAF',
...
def test_navigation_when_nes_in_another_ns(service):
   ...
   """
    ...
    responses.add(
        responses.GET,
        f"{service.url}/Customers('Mammon')/Orders?$format=json",
        json={'d': {'results' : [{
            'Number': '456',
            'Owner': 'Mammon',
        }]}},
...
def test_entity_get_value_with_proxy(service):
    ...
    responses.add(
        responses.GET,
        f"{service.url}/CarIDPics('Hadraplan')?$format=json",
        headers={'Content-type': 'application/json'},
        json = { 'd': {
            'CarName': 'Hadraplan',
            'Content': 'DEADBEAF',
...
def test_navigation_from_entity_multi(service):
    ...
    responses.add(
        responses.GET,
        f"{service.url}/Employees(23)?$format=json",
        json={'d': {
            'ID': 23,
            'NameFirst': 'Rob',
            'NameLast': 'Ickes'
...
def test_get_entity_expanded(service):
    ...
    responses.add(
        responses.GET,
        f"{service.url}/Employees(23)?$format=json&$expand=Addresses",
        json={'d': {
            'ID': 23,
            'NameFirst': 'Rob',
            'NameLast': 'Ickes',
...
def test_inlinecount(service):
    ...
    responses.add(
        responses.GET,
        f"{service.url}/Employees?$format=json&$inlinecount=allpages",
        json={'d': {
            '__count': 3,
            'results': [
                {
...
def test_inlinecount_with_skip(service):
    ...
    responses.add(
        responses.GET,
        f"{service.url}/Employees?$format=json&$inlinecount=allpages&$skip=1",
        json={'d': {
            '__count': 3,
            'results': [
                {
...
def test_navigation_inlinecount(service):
    ...
    responses.add(
        responses.GET,
        f"{service.url}/Employees(23)/Addresses?$format=json&$inlinecount=allpages",
        json={'d': {
            '__count': 3,
            'results': [
                {
...
def test_inlinecount_with_filter(service):
    ...
    responses.add(
        responses.GET,
        f"{service.url}/Employees(23)/Addresses?$format=json&$inlinecount=allpages&%24filter=City%20eq%20%27London%27",
        json={'d': {
            '__count': 2,
            'results': [
                {
...
def test_partial_listing(service):
    ...
    responses.add(
        ...
        json={'d': {
            '__count': 3,
            '__next': f"{service.url}/Employees?$format=json&$inlinecount=allpages&$skiptoken='opaque'",
            'results': [
                {
                    'ID': 21,
                    'NameFirst': 'George',
    ...
    responses.add(
        responses.GET,
        f"{service.url}/Employees?$format=json&$inlinecount=allpages&$skiptoken='opaque'",
        json={'d': {
            '__count': 3,
            'results': [
                {
...
def test_create_entity_with_utc_datetime(service):
    ...
    responses.add(
        responses.POST,
        f"{service.url}/TemperatureMeasurements?$format=json",
        headers={'Content-type': 'application/json'},
        json={'d': {
            'Sensor': 'Sensor1',
            'Date': '/Date(1514138400000)/',
...
def test_custom_with_get_entity(service):
    ...
    responses.add(
        responses.GET,
        f"{service.url}/MasterEntities('12345')?$format=json&foo=bar",
        headers={'Content-type': 'application/json'},
        json={'d': {'Key': '12345'}},
        status=200)
...
def test_custom_with_get_entity_url_params(service):
    ...
    assert oDataHttpRequest.get_query_params() == {'$format': 'json', 'foo': 'bar'}
...
def test_multiple_custom_with_get_entity_url_params(service):
    ...
    responses.add(
        responses.GET,
        f"{service.url}/MasterEntities('12345')?$format=json&foo=bar&$fizz=buzz",
        headers={'Content-type': 'application/json'},
        json={'d': {'Key': '12345'}},
        status=200)

    oDataHttpRequest = service.entity_sets.MasterEntities.get_entity('12345').custom("foo", "bar").custom("$fizz", "buzz")
    assert oDataHttpRequest.get_query_params() == {'$format': 'json', 'foo': 'bar', '$fizz': 'buzz'}
    assert oDataHttpRequest.get_path() == "MasterEntities('12345')"
...
def test_custom_with_create_entity_url_params(service):
    ...
    responses.add(
        responses.POST,
        f"{service.url}/MasterEntities?$format=json&foo=bar",
        headers={
            'Content-type': 'application/json',
            'ETag':  'W/\"J0FtZXJpY2FuIEFpcmxpbmVzJw==\"'
        },
